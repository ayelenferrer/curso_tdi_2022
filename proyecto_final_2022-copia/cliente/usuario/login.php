  ...
  if (empty($email)) {
    ...
    if (mysqli_num_rows($result) === 1) {
      ...
      if ($row['email'] === $email && $row['clave'] === $clave) {
        ...
        if ($row['estado'] == 1) {
          $_SESSION['tipo'] = "ADMIN";
          header("Location: ../../admin/usuarios/administradores.php");
        } else {
          $_SESSION['tipo'] = "CLIENTE";
          header("Location: ../../cliente/productos/productos.php");
        }
    ...
    <div class="wrap-login100 p-t-50 p-b-90">
      <form class="login100-form validate-form flex-sb flex-w" action="" method="POST">
        ...
        <div class="container-login100-form-btn m-t-17">
          <p class="message pp">¿No tenes una cuenta? <a class="pp crear" href="registro.php">Crear cuenta</a></p>
