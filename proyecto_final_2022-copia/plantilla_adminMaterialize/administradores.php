          ...
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
              <ul class="collapsible" data-collapsible="accordion">
                ...
                <li class="bold">
                  <a href="../crearProducto.php" class="waves-effect waves-cyan">
                      <i class="material-icons">apps</i>
                      <span class="nav-text">Productos</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="../categorias.php" class="waves-effect waves-cyan">
              ...
              <div class="col s12 m6 l3">
                <div class="card purple lighten-3 gradient-shadow min-height-100 white-text">
                  <div class="padding-4">
                    ...
                    <div class="card-action">
                      <a href="../crearProducto.php" class="waves-effect waves-light btn gradient-45deg-purple-pink">Ver</a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col s12 m6 l3">
                <div class="card purple lighten-3 gradient-shadow min-height-100 white-text">
                  <div class="padding-4">
                    ...
                    <div class="card-action">
                      <a href="../categorias.php" class="waves-effect waves-light btn gradient-45deg-purple-pink">Ver</a>
                    </div>
                  </div>
                </div>
              </div>
